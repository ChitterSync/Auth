...
const resolvePostMessageOrigin = (targetUrl: string) => {
  try {
...
const postAuthMessage = (payload: Record<string, unknown>, targetOrigin: string) => {
...
export default function SetupPage() {
  const defaultHome =
    process.env.NEXT_PUBLIC_CHITTERHAVEN_HOME_URL || "https://ch.chittersync.com/";
  ...
  const saveSetup = async () => {
    ...
    try {
      ...
      const finalUrl = buildTutorialUrl(redirectUrl || defaultHome);
